...
foreach ($i in $cases) {
    foreach ($j in $settings) {
        Write-Host "========================================="
        Write-Host "Running python mdr_conc.py $i $j 0.1 20 0.95 10 1000 100 100 0"
        Write-Host "========================================="
        python mdr_conc.py $i $j 0.1 20 0.95 10 1000 100 100 0
        # python mdr.py $i $j 0.1 20 10 1000 100 100 0
        # python mdr_ltt.py $i $j 0.1 20 0.95 10 1000 100 100 0
