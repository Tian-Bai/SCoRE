...
all_res.to_csv(os.path.join('sdr_results', f"SCoRE_SDR_w{weight_type}, case={case_idx}, setting={setting}, sigma={sig}, tau={tau}, ncalib={ncalib}, ntest={ntest}, Nrep={Nrep}, seedgroup={seedgroup}, reward={reward_type}, oracle={oracle}, fit_Y={fit_Y}, oracle_mdl={oracle_mdl}, oracle_w={oracle_weight}.csv"))
